...
class TransaksiDetailSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($transaksi as $t) {
            $numberOfDetails = $faker->numberBetween(5, 15); // Menambahkan angka antara 5 - 15
            $total_harga = 0;
            ...
            for ($j = 0; $j < $numberOfDetails; $j++) {
                ...
                // Menggunakan ::create untuk menambahkan data ke TransaksiDetail
                TransaksiDetail::create([
                    'id_transaksi' => $t->id,
                    'nama_produk' => $faker->productName,
                    'harga_satuan' => $hargaSatuan,
                    'jumlah' => $jumlah,
                    'subtotal' => $subtotal // Menambahkan nilai subtotal
                ]);
            }

            // Update total harga, bayar, dan kembalian
